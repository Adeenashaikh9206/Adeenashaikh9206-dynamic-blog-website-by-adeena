          ...
          <div className="flex flex-col md:flex-row">
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-50 text-lg">
                ...
                &apos   If youre looking for a dedicated developer who loves coding and creativity, feel free to connect with me!
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-50">
              From curious beginner to seasoned developer, heres how Harry navigated the world of programming.
            </p>
          </div>
          <div className="space-y-12">
            ...
            <motion.div
              ...
              transition={{ duration: 1, delay: 0.5 }}
            >
              <Image src="/miss.avif" alt="Example" width={500} height={300} />
